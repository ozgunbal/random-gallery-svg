...
const Collage = (props) => {
    debugger
  const { images, original } = props
  return (
    <svg width='100%' height='100%' viewBox='0 0 492 503' fill='none' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink'>
      ...
      <text x='163' y='220' fill='white' textAnchor='middle'>Original</text>
      <text x='350' y='490' fill='white' textAnchor='middle'>Avatar</text>
      <text x='412' y='280' fill='white' textAnchor='middle'>Stories</text>
      <text x='163' y='320' fill='white' textAnchor='middle'>Banner</text>
      <defs>
